...
date = '2023-04-03 15:00:00'  # start of night date
...
target_chilean = pd.DataFrame({'Date': date, 'Telescope': "Callisto", 'Name': 'Sp1300+1912',
                        'Start': '2023-04-04 04:00:00',
                        'End': '2023-04-04 06:00:00',
                        'RA':  195.1769102,
                        'DEC': 23,
                        'Filter': 'zYJ',
                        'texp': None,
                        'dist': 14,
                        'Teff': 2152,
                        'Counts': counts, '#target': 1, 'Gaia_ID': 'gaia_id', 'Jmag': 12.72, 'SpT': 'L0'},
                              index=[0])
