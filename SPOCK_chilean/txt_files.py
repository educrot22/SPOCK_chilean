...
def target(name, date_start, date_end, waitlimit, afinterval, autofocus, count, filt, exptime, ra1, ra2, ra3, dec1,
           dec2, dec3, name_2, Gaia_ID, Path):
    ...
    with open(os.path.join(Path, 'Obj_' + name_file), 'w') as out:
        ...
        if int(dec1) == -0:
            out.write(name + '\t' + str('{:02d}'.format(int(ra1))) + ' ' + str('{:02d}'.format(int(ra2))) + ' ' + str(
                '{:05.2f}'.format(float(ra3))) + '\t' + '-' + str('{:02d}'.format(int(dec1)))
                      + ' ' + str('{:02d}'.format(int(abs(dec2)))) + ' ' + str(
                '{:05.2f}'.format(abs(dec3))) + '\n')  # 8*np.cos(c.dec.radian)
        if int(dec1) < 0 and int(dec1) != -0:
            out.write(name + '\t' + str('{:02d}'.format(int(ra1))) + ' ' + str('{:02d}'.format(int(ra2))) + ' ' + str(
                '{:05.2f}'.format(float(ra3))) + '\t' + '-' + str('{:02d}'.format(int(abs(dec1))))
...
def first_target(name, date_start, date_end, waitlimit, afinterval, autofocus, count, filt, exptime, ra1, ra2, ra3,
                 dec1, dec2, dec3, name_2, Gaia_ID, Path):
...
def flatexo_gany(Path, filt, nbOIII=None, nbHa=None, nbSII=None, nbz=None, nbr=None, nbi=None, nbg=None, nbIz=None,
                 nbExo=None, nbClear=None):
...
def flatexo_calli(Path, filt, nbu=None, nbB=None, nbz=None, nbV=None, nbr=None, nbi=None, nbg=None, nbIz=None,
                  nbExo=None, nbClear=None):
...
def flatexo_euro(Path, filt, nbRc=None, nbB=None, nbz=None, nbV=None, nbr=None, nbi=None, nbg=None, nbIz=None,
                 nbExo=None, nbClear=None):
...
def flatexo_io(Path, filt, nbu=None, nbHa=None, nbRc=None, nbz=None, nbr=None, nbi=None, nbg=None, nbIz=None,
               nbExo=None, nbClear=None):
